...
/**
 * 用java实现的数组创建二叉树以及递归先序遍历，递归中序遍历，递归后序遍历，非递归前序遍历，
 * 非递归中序遍历，非递归后序遍历，深度优先遍历，广度优先遍历8种遍历方式。
 */
public class StudyTree {
    ...
    public static void main(String[] args) {
        ...
        int[] datas = new int[]{5,3,6,2,4,100,8,1,100,100,100,7,9};
        // 此处使用ArrayList() 一样的效果。建议使用LinkedList 因为
